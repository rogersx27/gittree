...
const parseEntry = (entry: string): Ref | null => {
...
// Convierte la decoracion completa de un commit (el campo %D) en refs tipadas.
// Una cadena vacia significa que ninguna ref apunta a ese commit.
export const parseRefs = (decoration: string): readonly Ref[] =>
  decoration.trim() === ""
    ? []
    : decoration
        .split(", ")
